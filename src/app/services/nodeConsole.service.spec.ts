...
describe('NodeConsoleService', () => {
  ...
  describe('getUrl', () => {
    it('should return ws URL for http protocol', () => {
      ...
      expect(url).toMatch(
        /^ws:\/\/localhost:3080\/v3\/projects\/project-1\/nodes\/node-1\/console\/ws\?token=test-token$/
      );
    });
    ...
    it('should return wss URL for https protocol', () => {
      ...
      expect(url).toMatch(
        /^wss:\/\/localhost:3080\/v3\/projects\/project-1\/nodes\/node-1\/console\/ws\?token=test-token$/
      );
    });
