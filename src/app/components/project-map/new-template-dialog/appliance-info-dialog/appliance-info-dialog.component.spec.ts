...
describe('ApplianceInfoDialogComponent', () => {
  ...
  const mockAppliance: Appliance = {
    ...
    dynamips: { chassis: 'c3725', nvram: 128, platform: 'c3700', ram: 128, slot0: 'NM-1FE-TX', slot1: 'NM-1FE-TX', slot2: '', slot3: '', slot4: '', slot5: '', slot6: '', slot7: '', startup_config: 'startup.conf' },
    iou: { ethernet_adapters: 2, nvram: 128, ram: 256, serial_adapters: 0, startup_config: 'iou.cfg' },
    qemu: { adapter_type: 'virtio', adapters: 4, arch: 'x86_64', boot_priority: 'c', console_type: 'vnc', hda_disk_interface: 'virtio', hdb_disk_interface: 'virtio', hdc_disk_interface: 'virtio', hdd_disk_interface: 'virtio', kvm: 'required', ram: 2048 },
  };
