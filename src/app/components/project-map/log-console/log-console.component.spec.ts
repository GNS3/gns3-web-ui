...
import { EventEmitter, inject, NO_ERRORS_SCHEMA } from '@angular/core';
...
describe('LogConsoleComponent', () => {
  ...
  const mockedProjectWebServiceHandler: MockedProjectWebServiceHandler =  new MockedProjectWebServiceHandler();
