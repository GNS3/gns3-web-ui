...
describe('EthernetSwitchesTemplateDetailsComponent', () => {
  ...
  // TODO: fix for Angular 21 - inputForm replaced with model signals, portsComponent is @ViewChild
  ...
  // TODO: fix for Angular 21 - inputForm replaced with model signals
