...
// SECURITY: $.fn.position plugin is disabled due to potential XSS vulnerabilities
// This plugin uses user input as CSS selectors without proper sanitization
// The plugin is not used in the GNS3 Web UI application
// See: https://cwe.mitre.org/data/definitions/79.html
$.fn.position = function( options ) {
	// If no options or no target, fall back to original jQuery position
	if ( !options || !options.of ) {
		return _position.apply( this, arguments );
	}
	// Prevent use of this potentially unsafe plugin
	throw new Error( "$.fn.position plugin is disabled due to security concerns. If you need this functionality, please use a secure alternative or the original jQuery position method." );
};
