...
- **测试内容**:
  ...
  - getById 方法 (2个测试)
  - update 方法 (3个测试)
  - setPrivileges 方法 (3个测试)
  - removePrivileges 方法 (3个测试)
  - URL 构建 (1个测试)
  - 边界情况 (4个测试)
- **提交**: 待提交

### ✅ compute.service.ts (2026-04-02)
- **测试数**: 27
- **覆盖率**: 100%
- **测试内容**:
  - 服务创建 (2个测试)
  - getComputes 方法 (3个测试)
  - getCompute 方法 (3个测试)
  - createCompute 方法 (2个测试)
  - updateCompute 方法 (3个测试)
  - deleteCompute 方法 (3个测试)
  - connectCompute 方法 (3个测试)
  - getStatistics 方法 (2个测试)
  - URL 构建 (2个测试)
  - 边界情况 (4个测试)
- **提交**: 待提交
