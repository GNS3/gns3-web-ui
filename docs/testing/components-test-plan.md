# Components Test Coverage Progress
...
- [ ] 10 / 231 components completed (4.3%)
...
- [x] information-dialog/information-dialog.component.ts
- [x] question-dialog/question-dialog.component.ts

### direct-link (1 component)
- [ ] direct-link.component.ts
...
- [ ] export-portable-project.component.ts
...
#### built-in (9 components)
- [ ] built-in/built-in-preferences.component.ts
- [ ] built-in/cloud-nodes/cloud-nodes-add-template/cloud-nodes-add-template.component.ts
- [ ] built-in/cloud-nodes/cloud-nodes-template-details/cloud-nodes-template-details.component.ts
- [ ] built-in/cloud-nodes/cloud-nodes-templates/cloud-nodes-templates.component.ts
- [ ] built-in/ethernet-hubs/ethernet-hubs-add-template/ethernet-hubs-add-template.component.ts
- [ ] built-in/ethernet-hubs/ethernet-hubs-template-details/ethernet-hubs-template-details.component.ts
- [ ] built-in/ethernet-hubs/ethernet-hubs-templates/ethernet-hubs-templates.component.ts
- [ ] built-in/ethernet-switches/ethernet-switches-add-template/ethernet-switches-add-template.component.ts
- [ ] built-in/ethernet-switches/ethernet-switches-template-details/ethernet-switches-template-details.component.ts
- [ ] built-in/ethernet-switches/ethernet-switches-templates/ethernet-switches-templates.component.ts

#### common (9 components)
- [ ] common/custom-adapters/custom-adapters.component.ts
- [ ] common/custom-adapters-table/custom-adapters-table.component.ts
- [ ] common/delete-confirmation-dialog/delete-confirmation-dialog.component.ts
- [ ] common/delete-template-component/delete-template.component.ts
- [ ] common/empty-templates-list/empty-templates-list.component.ts
- [ ] common/ports/ports.component.ts
- [ ] common/symbols-menu/symbols-menu.component.ts
- [ ] common/symbols/symbols.component.ts
- [ ] common/symbols/symbols-manager-dialog/symbols-manager-dialog.component.ts
- [ ] common/udp-tunnels/udp-tunnels.component.ts

#### docker (4 components)
- [ ] docker/add-docker-template/add-docker-template.component.ts
- [ ] docker/copy-docker-template/copy-docker-template.component.ts
- [ ] docker/docker-template-details/docker-template-details.component.ts
- [ ] docker/docker-templates/docker-templates.component.ts

#### dynamips (5 components)
- [ ] dynamips/add-ios-template/add-ios-template.component.ts
- [ ] dynamips/copy-ios-template/copy-ios-template.component.ts
- [ ] dynamips/dynamips-preferences/dynamips-preferences.component.ts
- [ ] dynamips/ios-template-details/ios-template-details.component.ts
- [ ] dynamips/ios-templates/ios-templates.component.ts

#### general (1 component)
- [ ] general/general-preferences.component.ts

#### ios-on-unix (4 components)
- [ ] ios-on-unix/add-iou-template/add-iou-template.component.ts
- [ ] ios-on-unix/copy-iou-template/copy-iou-template.component.ts
- [ ] ios-on-unix/iou-template-details/iou-template-details.component.ts
- [ ] ios-on-unix/iou-templates/iou-templates.component.ts

#### qemu (5 components)
- [ ] qemu/add-qemu-vm-template/add-qemu-vm-template.component.ts
- [ ] qemu/copy-qemu-vm-template/copy-qemu-vm-template.component.ts
- [ ] qemu/qemu-preferences/qemu-preferences.component.ts
- [ ] qemu/qemu-vm-template-details/qemu-vm-template-details.component.ts
- [ ] qemu/qemu-vm-templates/qemu-vm-templates.component.ts

#### virtual-box (4 components)
- [ ] virtual-box/add-virtual-box-template/add-virtual-box-template.component.ts
- [ ] virtual-box/virtual-box-preferences/virtual-box-preferences.component.ts
- [ ] virtual-box/virtual-box-template-details/virtual-box-template-details.component.ts
- [ ] virtual-box/virtual-box-templates/virtual-box-templates.component.ts

#### vmware (4 components)
- [ ] vmware/add-vmware-template/add-vmware-template.component.ts
- [ ] vmware/vmware-preferences/vmware-preferences.component.ts
- [ ] vmware/vmware-template-details/vmware-template-details.component.ts
- [ ] vmware/vmware-templates/vmware-templates.component.ts

#### vpcs (4 components)
- [ ] vpcs/add-vpcs-template/add-vpcs-template.component.ts
- [ ] vpcs/vpcs-preferences/vpcs-preferences.component.ts
- [ ] vpcs/vpcs-template-details/vpcs-template-details.component.ts
- [ ] vpcs/vpcs-templates/vpcs-templates.component.ts

#### preferences (1 component)
- [ ] preferences.component.ts

### project-map (65 components)

#### ai-chat (6 components)
- [ ] ai-chat/ai-chat.component.ts
- [ ] ai-chat/chat-input-area.component.ts
- [ ] ai-chat/chat-message-list.component.ts
- [ ] ai-chat/chat-session-list.component.ts
- [ ] ai-chat/tool-call-display.component.ts
- [ ] ai-chat/tool-details-dialog.component.ts

#### change-hostname-dialog (1 component)
- [ ] change-hostname-dialog/change-hostname-dialog.component.ts

#### change-symbol-dialog (1 component)
...
- [ ] draw-link-tool/draw-link-tool.component.ts

#### help-dialog (1 component)
- [ ] help-dialog/help-dialog.component.ts

#### import-appliance (1 component)
- [ ] import-appliance/import-appliance.component.ts

#### info-dialog (1 component)
...
- [ ] node-select-interface/node-select-interface.component.ts

#### nodes-menu (2 components)
- [ ] nodes-menu/nodes-menu.component.ts
- [ ] nodes-menu/nodes-menu-confirmation-dialog/nodes-menu-confirmation-dialog.component.ts

#### packet-capturing (2 components)
- [ ] packet-capturing/packet-filters/packet-filters.component.ts
- [ ] packet-capturing/start-capture/start-capture.component.ts

#### project-map (5 components)
- [ ] project-map.component.ts
- [ ] project-map-menu/project-map-lock-confirmation-dialog/project-map-lock-confirmation-dialog.component.ts
- [ ] project-map-menu/project-map-menu.component.ts
- [ ] project-readme/project-readme.component.ts
- [ ] screenshot-dialog/screenshot-dialog.component.ts

#### template-symbol-dialog (1 component)
- [ ] template-symbol-dialog/template-symbol-dialog.component.ts

#### web-console (1 component)
...
- [ ] delete-resource-confirmation-dialog/delete-resource-confirmation-dialog.component.ts
- [ ] resource-pool-details.component.ts
...
- [ ] create-snapshot-dialog/create-snapshot-dialog.component.ts
- [ ] snapshot-dialog/snapshot-dialog.component.ts
- [ ] snapshot-menu-item/snapshot-menu-item.component.ts
...
- [ ] template-list-dialog/template-list-dialog.component.ts
...
### users (1 component)
- [ ] logged-user/logged-user.component.ts

### web-console-full-window (1 component)
- [ ] web-console-full-window.component.ts
...
|------|--------|------------|-------|
| 2026-04-02 | 8fffb355 | QuestionDialogComponent | 3 |
| 2026-04-02 | 39163e44 | InformationDialogComponent | 3 |
| 2026-04-02 | 34c14d78 | ConfirmationDialogComponent | 11 |
| 2026-04-02 | e8e39fcf | ControllersComponent | 6 |
| 2026-04-02 | c5f2b459 | ComputesComponent | 16 |
...
| 2026-04-02 | 651e2489 | BackgroundUploadService | 43 |
| 2026-04-02 | c094480f | XtermContextMenuService | 34 |
| 2026-04-02 | d39bf0eb | WindowBoundaryService | 63 |
| 2026-04-02 | f8919138 | HttpControllerService | 47 |
| 2026-04-02 | ae382388 | XtermService | 39 |
| 2026-04-02 | aef569c2 | ControllerService | 49 |
| 2026-04-02 | 9d081737 | ImageUploadSessionService | 34 |
| 2026-04-02 | e1723aa7 | ProtocolHandlerService | 27 |
| 2026-04-02 | e2578113 | ControllerManagementService | 28 |

**Service tests completed**: 12 services, 527 tests
**Component tests completed**: 10 components, 79 tests
**Total**: 1857 tests passing
